...
// fs.readFile(process.env.GOOGLE_APPLICATION_CREDENTIALS, (err) => {
//     if (err) {
...
//         };
//     },
//     callback: (client: Auth.OAuth2Client) => void
// ) {
 ...
 */
// function getCode(auth: Auth.OAuth2Client): Promise<string> {
//     return new Promise(async (resolve) => {
//         const gmail = google.gmail({ version: "v1", auth });
//         const messages = await getAllMessages(gmail);
//         const threads = await Promise.all(
//             messages.map((message) => getThread(gmail, message.threadId))
//         );
...
//                     (header) =>
//                         header.name === "From" &&
//                         header.value === "Instagram <security@mail.instagram.com>"
//                 )
//             )
//             .map((mail) => {
//                 return {
...
//         resolve(
//             codeSnippet.snippet.substring(
//                 codeSnippet.snippet.length - 7,
//                 codeSnippet.snippet.length - 1
//             )
//         );
//     });
// }

// function getAllMessages(gmail: gmail_v1.Gmail): Promise<gmail_v1.Schema$Message[]> {
...
// function getThread(gmail: gmail_v1.Gmail, threadId: string): Promise<gmail_v1.Schema$Message[]> {
//     return new Promise((resolve, reject) => {
